...
namespace OptionOptimiser.Objects
{
    internal class Option
    {
        ...
        public Option(string Symbol)
        {
            ...
            TheoreticalValue = BinomialCalculators.BinomialWithDividends(Steps, Spot, Strike, RiskFreeRate, Volatility, TimeToMaturity, PutCall, EuroAme, underlying);
            ImpliedVolatility = VolatilityCalculators.CalculateImpliedVolatility(Volatility, TheoreticalValue, Spot, Strike, TimeToMaturity, RiskFreeRate, call);
        ...
        private static double SetStrikePrice()
        {
            while (true)
            {
